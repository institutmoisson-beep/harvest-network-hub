  ...
  <footer className="border-t border-border/50 bg-card/50 py-12">
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <h4 className="font-display text-xs uppercase tracking-wider text-secondary mb-3">Navigation</h4>
        ...
        <div>
          <h4 className="font-display text-xs uppercase tracking-wider text-secondary mb-3">Communauté</h4>
          <div className="flex flex-col gap-2 text-sm text-muted-foreground">
            <span className="flex items-center gap-2"><Wheat size={14} className="text-secondary" /> Spirituel & Scientifique</span>
            <span className="flex items-center gap-2"><Wheat size={14} className="text-secondary" /> Penseurs & Technocrates</span>
            <span className="flex items-center gap-2"><Wheat size={14} className="text-secondary" /> Tous unis, jamais seuls</span>
          </div>
        </div>
      </div>
